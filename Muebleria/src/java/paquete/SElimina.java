 ...
 */
public class SElimina extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        throws ServletException, IOException {
            response.setContentType("text/html;charset=UTF-8");
            PrintWriter out = response.getWriter();
            HttpSession session = request.getSession();
            String userToD=request.getParameter("userToD");
            System.out.println("*******************");
            System.out.println(userToD);
            System.out.println("*******************");
            /*
            ...
            try{
                ...
                try{
                    ...
                    /*Eliminando etiqueta*/
                    leer.eliminarEtiqueta(lista, userToD);//Recibe todo lo nuevo
                    ...
                    out.println("<!DOCTYPE html>");
                        ...
                        out.println("<script type='text/javascript'>" +
                                    " alert('Se Elimino al usuario "+userToD+" con éxito!'); window.location='Admi-n.jsp';" +
                                    "</script>");
                        out.println("</body>");
                        out.println("</html>");
